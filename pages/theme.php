<template>
  ...
  <span                   style="font-weight: 300; font-family:myFirstFont" class="ios-only">چوونەدەرەوە</span>
  </a>
  </div>
  <div                    style="font-weight: 600; font-family:myFirstFont" class="title">گۆڕینی ڕووکار </div>
  </div>
  </div>
  <div class="page-content">
  <div class="block-title">              Tayout</div>
  <div class="block">
